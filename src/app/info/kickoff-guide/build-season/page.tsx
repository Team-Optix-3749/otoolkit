...
import { Wrench, Calendar, Rocket, Users, ArrowLeft, ExternalLink, Clock, Target, AlertTriangle } from "lucide-react";
        ...
        <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-50">
            ...
            <main className="container mx-auto px-4 py-12 max-w-5xl">
                ...
                <header className="mb-12 space-y-4">
                    ...
                    <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400 bg-clip-text text-transparent">
                        Build Season
                    </h1>
                ...
                <section className="mb-12 bg-white dark:bg-neutral-900 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-red-600 p-6 rounded-2xl text-white my-6">
                        ...
                        <div className="bg-orange-50 dark:bg-orange-950/20 p-5 rounded-xl border-l-4 border-orange-500">
                            <p className="font-semibold text-orange-900 dark:text-orange-100 mb-1">💪 Embrace Setbacks</p>
                ...
                <section className="mb-12 bg-white dark:bg-neutral-900 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-xl border-l-4 border-blue-500 my-6">
                            <p className="font-semibold text-blue-900 dark:text-blue-100 mb-1">🎯 Strategic Focus</p>
                            <p className="text-neutral-700 dark:text-neutral-300 mb-0">
                        ...
                        <div className="grid md:grid-cols-3 gap-4 not-prose my-6">
                            <div className="p-5 bg-purple-50 dark:bg-purple-950/20 rounded-xl border border-purple-200 dark:border-purple-800">
                                <h4 className="font-bold text-lg mb-2">Drivetrain</h4>
                            ...
                            <div className="p-5 bg-cyan-50 dark:bg-cyan-950/20 rounded-xl border border-cyan-200 dark:border-cyan-800">
                                <h4 className="font-bold text-lg mb-2">Strategic Capabilities</h4>
                                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                            ...
                            <div className="p-5 bg-emerald-50 dark:bg-emerald-950/20 rounded-xl border border-emerald-200 dark:border-emerald-800">
                                <h4 className="font-bold text-lg mb-2">Prototyping Groups</h4>
                                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                ...
                <section className="mb-12 bg-white dark:bg-neutral-900 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div className="bg-gradient-to-r from-red-500 to-orange-600 p-6 rounded-2xl text-white mt-8">
                ...
                <section className="mb-12 bg-white dark:bg-neutral-900 rounded-3xl p-8 shadow-sm border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <div className="bg-cyan-50 dark:bg-cyan-950/20 p-4 rounded-xl border-l-4 border-cyan-500 mt-4">
                            <p className="font-semibold text-cyan-900 dark:text-cyan-100 mb-1">🤝 Team Culture</p>
                            <p className="text-neutral-700 dark:text-neutral-300 mb-0">
                ...
                {/* Fail Faster */}
                <section className="mb-12 bg-gradient-to-br from-red-600 to-orange-700 rounded-3xl p-8 shadow-xl text-white">
